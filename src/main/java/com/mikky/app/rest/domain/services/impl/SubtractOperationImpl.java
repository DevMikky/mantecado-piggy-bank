...
@Service
public class SubtractOperationImpl implements BalanceOperation {

    private final UserBalanceRepository userBalanceRepository;

    private final BalanceTransactionRepository transactionRepository;

    public SubtractOperationImpl(UserBalanceRepository userBalanceRepository,
    ...
    public String executeOperation(Long userId) {
        ...
        return "Substraccion de balance realizado exitosamente";
    }
    ...
    private void updateBalance(Long userId) {
        ...
        BigDecimal newBalance = userBalance.getBalance().subtract(ConstantsUtil.ADD_SUBTRACT_VALUE);
